                                               ...
                                               int*                lwork)
{
    return hipsolverSsyevd_bufferSize(
        handle, jobz, uplo, n, const_cast<float*>(A), lda, const_cast<float*>(D), lwork);
}
                                               ...
                                               int*                lwork)
{
    return hipsolverDsyevd_bufferSize(
        handle, jobz, uplo, n, const_cast<double*>(A), lda, const_cast<double*>(D), lwork);
}
                                               ...
                                               int*                   lwork)
{
    return hipsolverCheevd_bufferSize(
        handle, jobz, uplo, n, const_cast<hipFloatComplex*>(A), lda, const_cast<float*>(D), lwork);
}
